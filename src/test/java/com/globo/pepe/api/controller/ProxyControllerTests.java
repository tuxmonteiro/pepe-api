...
@WebMvcTest({ProxyController.class, RestTemplate.class})
public class ProxyControllerTests {
    ...
    @Test
    public void apiPostTest() throws Exception {
        mockMvc.perform(post("/api/testapi").content("{\"path\":\"api\"}")
